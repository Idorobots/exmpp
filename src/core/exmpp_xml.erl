...
-spec(attribute_matches(xmlattr(), xmlname(), xmlname() | attributename()) -> bool()).
...
%%
%% -spec(get_attribute_node_from_list([], xmlname())              -> undefined;
...
%% inside those list(), we specify a less strict contract.
%%
%% -spec(get_attribute_from_list([], attributename(), Default)              -> Default;
...
-spec(has_attribute_in_list([xmlattr()] | [xmlattr_old()], attributename()) -> bool()).
...
-spec(has_attribute_in_list([xmlattr()], xmlname(), attributename()) -> bool()).
...
-spec(has_attribute(xmlel_any() | undefined, attributename()) -> bool()).
...
-spec(has_attribute(xmlel_any() | undefined, xmlname(), attributename()) -> bool()).
...
%% inside those list(), we specify a less strict contract.
%%
%% -spec(set_attribute_in_list([], xmlattr()                   -> [xmlattr()];
...
%% inside those list(), we specify a less strict contract.
%%
%% -spec(set_attribute_in_list([xmlattr()], attributename(), binary() | string() | atom() | integer()) ->
%%       [xmlattr()];
...
%% inside those list(), we specify a less strict contract.
%%
%% -spec(remove_attribute_from_list([], attributename())              -> [];
...
-spec(has_element(xmlel_any() | undefined, xmlname()) -> bool()).
...
-spec(has_element(xmlel() | undefined, xmlname(), xmlname()) -> bool()).
...
-spec(has_element_by_ns(xmlel() | undefined, xmlname()) -> bool()).
...
-spec(filter(fun((xmlel_any(), xmlnode()) -> bool()), xmlel_any()) -> xmlel_any()).
